...
class DateTest extends UnitAbstract
{
    ...
    public function setDateByInteger()
    {
        ...
        $this->assert($date === '2010-01-01T00:00:00Z', 'The date was not set from an integer');
    }
    ...
    public function setDateByString()
    {
        ...
        $this->assert($date === '2010-01-01T00:00:00Z', 'The date was not set from a string');
    }
    ...
    public function formatDate()
    {
        ...
        $date = $date->translate($this->time);
        $this->assert($date === '2010-01-01T00:00:00', 'The date format was not used');
    }
